    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative lg:flex lg:inline-flex lg:items-center bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: false }">
                <button @click="show = !show" @click.away="show = false" class="py-2 pl-3 pr-9 text-sm w-full lg:w-32 font-semibold inline-flex">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 w-full mt-2 rounded-xl w-full z-50" style="display: none">
                    <a href="/"
                       class="block text-left px-3 text-xs leading-5 hover:bg-blue-500 focus:hover:bg-blue-500 hover:text-white focus:hover:text-white"
                    >
                        All
                    </a>
